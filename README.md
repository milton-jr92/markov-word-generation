...
**Example**: In the sentence 'the raven and the fox', the word the has a 50% chance of being followed by raven and 50% chance of being followed by fox, while the word and has a 100% chance of being followed by the.
...
This project was developed using a custom version of the BlueJ Development Environment available at:

http://www.dukelearntoprogram.com/course4/index.php

Open the project from BlueJ env and to run the tests, create a new MarkovRunner object from MarkovRunner class and run the methods runMarkov() and runMarkovWithHash(). It will display a modal to select the training text from the Data folder.
